...
#include <time.h>
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#define  TS		1 //the outer iteration times 
#define  N	    85900
#define  OPT	142382641
#define  it     10// the iteration times
...
loopC1:	;
				...
				df=sqrt((*(p1+cpSO[j][cityA-1])-*(p1+cpSO[j][cityB]))*(*(p1+cpSO[j][cityA-1])-*(p1+cpSO[j][cityB]))+(*(p1+N+cpSO[j][cityA-1])-*(p1+N+cpSO[j][cityB]))*(*(p1+N+cpSO[j][cityA-1]-*(p1+N+cpSO[j][cityB])))+
                  sqrt((*(p1+cpSO[j][cityA])-*(p1+cpSO[j][cityB+1]))*(*(p1+cpSO[j][cityA])-*(p1+cpSO[j][cityB+1]))+(*(p1+N+cpSO[j][cityA])-*(p1+N+cpSO[j][cityB+1]))*(*(p1+N+cpSO[j][cityA]-*(p1+N+cpSO[j][cityB+1])))-
                  sqrt((*(p1+cpSO[j][cityA-1])-*(p1+cpSO[j][cityA]))*(*(p1+cpSO[j][cityA-1])-*(p1+cpSO[j][cityA]))+(*(p1+N+cpSO[j][cityA-1])-*(p1+N+cpSO[j][cityA]))*(*(p1+N+cpSO[j][cityA-1]-*(p1+N+cpSO[j][cityA])))-
                  sqrt((*(p1+cpSO[j][cityB])-*(p1+cpSO[j][cityB+1]))*(*(p1+cpSO[j][cityB])-*(p1+cpSO[j][cityB+1]))+(*(p1+N+cpSO[j][cityB])-*(p1+N+cpSO[j][cityB+1]))*(*(p1+N+cpSO[j][cityB]-*(p1+N+cpSO[j][cityB+1]))) ;
				if(df<0)
				{
					city1=cityA;
					city2=cityB;
