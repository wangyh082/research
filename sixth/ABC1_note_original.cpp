...
int main()
{
    ...
    int mmin=999999;   
    srand(time(0));
    out1=fopen("Ta001_3_result2.txt","w");
        scanf("%d%d",&job,&step);
        scanf("%d",&f);
        ...
        for(int i=1;i<=job;i++)
          ...
          int num[2];//the first way needs two rand numbers 
          srand(time(0));          
          int t;  
          int final=999999;         
          for(int i=1;i<=50;i++)
         {
            ...
            int min2=9999999;
            int result;//the best of the ten individuals to be the VND process
            protime2(f);     
          for(int k=1;k<=10;k++)
          {    
              int kkk=0;
              int min1=tt[k];
              fprintf(out1,"k=0 time=%d\n",min1);       
             ...
             if(t<min1)
             {
              ...
              for(int i=1;i<=f;i++)//the fourth way
              {
                   ...
                   t=protime(temp1[4][i],fnn[k][i],step);
                   if(t>max)
                   {
                        max=t;
              ...
              if(kkk!=0)
              {
                  for(int i=1;i<=f;i++)
                    ...
                    ftt[k]=min1;
                    fprintf(out1,"the best individual is:\n");
                    display(k);                                         
       } 
       for(int k=1;k<=10;k++)
       {
